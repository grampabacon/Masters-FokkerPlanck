...
def plot_plane():
    ...
    plt.tick_params(axis='x', direction='in', length=6, labelsize=12)
    plt.tick_params(axis='y', direction='in', length=6, labelsize=12)

    plt.xlabel("W (units of $W_c$)", fontsize=14)
    plt.ylabel("$e V_b$ (units of $W_c$)", fontsize=14)
